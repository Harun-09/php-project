...
echo Form::open(["route"=>"supplier/update"]);
	...
	echo Form::input(["label"=>"Contact Person","type"=>"text","name"=>"contact_person","value"=>"$supplier->contact_person"]);
	...
	echo Form::input(["label"=>"Status","type"=>"textarea","name"=>"status","value"=>"$supplier->status"]);
