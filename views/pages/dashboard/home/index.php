<div class="tf-section-4 mb-30">
    ...
    <div class="wg-chart-default">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                <div class="image type-white">
                    <!-- Custom SVG for Order Box -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="52" viewBox="0 0 48 52" fill="none">
                        <path d="M4 12L24 2L44 12V40L24 50L4 40V12Z" fill="#3B82F6" />
                    </svg>
                    <!-- FontAwesome Icon -->
                    <i class="fas fa-clipboard-list"></i>
                </div>
    ...
    <div class="wg-chart-default">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                <div class="image type-white">
                    <!-- Custom SVG for Value Box -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="52" viewBox="0 0 48 52" fill="none">
                        <path d="M4 12L24 2L44 12V40L24 50L4 40V12Z" fill="#10B981" />
                    </svg>
                    <!-- FontAwesome Icon -->
                    <i class="fas fa-dollar-sign"></i>
                </div>
                <div>
                    <div class="body-text mb-2"><strong>Total Production Value</strong></div>
                    <h4>$37,802</h4>
                </div>
            </div>
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center gap14">
                                             ...
                                             <div class="box-icon-trending up">
                                                        ...
                                                        <div class="body-title number">+1.58%</div>
                                                    </div>
                                                </div>
                                                <div class="wrap-chart">
                                                    <div id="line-chart-efficiency"></div>
                                                </div>
                                            </div> -->
    ...
    <div class="wg-chart-default">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                <div class="image type-white">
                    <!-- Custom SVG for Efficiency -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="52" viewBox="0 0 48 52" fill="none">
                        <path d="M19.1094 2.12943C22.2034 0.343099 26.0154 0.343099 29.1094 2.12943L42.4921 9.85592C45.5861 11.6423 47.4921 14.9435 47.4921 18.5162V33.9692C47.4921 37.5418 45.5861 40.8431 42.4921 42.6294L29.1094 50.3559C26.0154 52.1423 22.2034 52.1423 19.1094 50.3559L5.72669 42.6294C2.63268 40.8431 0.726688 37.5418 0.726688 33.9692V18.5162C0.726688 14.9435 2.63268 11.6423 5.72669 9.85592L19.1094 2.12943Z" fill="#F59E0B" />
                    </svg>
                    <!-- FontAwesome Icon -->
                    <i class="fas fa-chart-line"></i>
                </div>
                <div>
                    <div class="body-text mb-2"><strong>Production Efficiency</strong></div>
                    <h4>92%</h4>
                </div>
            </div>
            <div class="box-icon-trending up">
    ...
    <div class="wg-chart-default">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                <div class="image type-white">
                    <!-- Custom SVG -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="52" viewBox="0 0 48 52" fill="none">
                        <path d="M19.1094 2.12943C22.2034 0.343099 26.0154 0.343099 29.1094 2.12943L42.4921 9.85592C45.5861 11.6423 47.4921 14.9435 47.4921 18.5162V33.9692C47.4921 37.5418 45.5861 40.8431 42.4921 42.6294L29.1094 50.3559C26.0154 52.1423 22.2034 52.1423 19.1094 50.3559L5.72669 42.6294C2.63268 40.8431 0.726688 37.5418 0.726688 33.9692V18.5162C0.726688 14.9435 2.63268 11.6423 5.72669 9.85592L19.1094 2.12943Z" fill="#6366F1" />
                    </svg>
                    <!-- FontAwesome Icons -->
                ...
                <div>
                    <div class="body-text mb-2"><b>Staff & Machines</b></div>
                    <h4>12 Staff / 5 Machines</h4>
                </div>
            </div>
            <div class="box-icon-trending up">
                <i class="fas fa-arrow-up"></i>
        ...
        <div class="wrap-chart">
            <div id="line-chart-staff-machine"></div>
        </div>
    </div>
    <!-- /chart-default -->
</div>
        ...
        <div class="wg-table table-top-product">
            <ul class="flex flex-column gap14">
                <li class="product-item">
                    <div class="image">
                        <img src="<?= $base_url ?>/assets/images/products/1.png" alt="">
                    </div>
                    <div class="flex items-center justify-between flex-grow">
                        ...
                        <div class="country">
                            <img src="<?= $base_url ?>/assets/images/country/2.png" alt="">
                        </div>
                        <div>
                ...
                <li class="product-item">
                    <div class="image">
                        <img src="<?= $base_url ?>/assets/images/products/2.png" alt="">
                    </div>
                    <div class="flex items-center justify-between flex-grow">
                        <div class="name">
                        ...
                        <div class="country">
                            <img src="<?= $base_url ?>/assets/images/country/3.png" alt="">
                        </div>
                        <div>
                            <div class="body-title-2 mb-3">-15%</div>
                            <div class="text-tiny">$27.00</div>
                ...
                <li class="product-item">
                    <div class="image">
                        <img src="<?= $base_url ?>/assets/images/products/3.png" alt="">
                    </div>
                    <div class="flex items-center justify-between flex-grow">
                        <div class="name">
                        ...
                        <div class="country">
                            <img src="<?= $base_url ?>/assets/images/country/1.png" alt="">
                        </div>
                        <div>
                            <div class="body-title-2 mb-3">-15%</div>
                            <div class="text-tiny">$27.00</div>
                ...
                <li class="product-item">
                    <div class="image">
                        <img src="<?= $base_url ?>/assets/images/products/4.png" alt="">
                    </div>
                    <div class="flex items-center justify-between flex-grow">
                        <div class="name">
                        ...
                        <div class="country">
                            <img src="<?= $base_url ?>/assets/images/country/4.png" alt="">
                        </div>
                        <div>
                            <div class="body-title-2 mb-3">-15%</div>
                            <div class="text-tiny">$27.00</div>
                ...
                <li class="product-item">
                    <div class="image">
                        <img src="<?= $base_url ?>/assets/images/products/5.png" alt="">
                    </div>
                    <div class="flex items-center justify-between flex-grow">
                        <div class="name">
                        ...
                        <div class="country">
                            <img src="<?= $base_url ?>/assets/images/country/5.png" alt="">
                        </div>
                        <div>
                            <div class="body-title-2 mb-3">-15%</div>
                            <div class="text-tiny">$27.00</div>
