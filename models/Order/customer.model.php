...
class Customer extends Model implements JsonSerializable
{
	...
	public function save()
	{
		...
		$db->query("INSERT INTO {$tx}customers (name, phone, email, address, created_at, updated_at)
                VALUES ('$this->name', '$this->phone', '$this->email', '$this->address', '$this->created_at', '$this->updated_at')");
		return $db->insert_id;
	}
